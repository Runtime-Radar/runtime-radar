...
func (x *RuntimeEvent) GetEventUrl() string {
	if x != nil {
		return x.EventUrl
	}
	return ""
...
type Threat struct {
	...
	// It's supposed to be a subset of tactics covered by the detector.
	TacticsCovered []*MitreTactic `protobuf:"bytes,4,rep,name=tactics_covered,json=tacticsCovered,proto3" json:"tactics_covered,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Threat) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *Threat) GetTacticsCovered() []*MitreTactic {
	if x != nil {
...
var file_runtime_event_proto_goTypes = []any{
	...
	(*MitreTactic)(nil),                // 5: detector.MitreTactic
}
var file_runtime_event_proto_depIdxs = []int32{
	...
	5, // 4: runtime_event.Threat.tactics_covered:type_name -> detector.MitreTactic
	4, // 5: runtime_event.DetectError.detector:type_name -> detector.Detector

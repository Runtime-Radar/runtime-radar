...
const (
	...
	KprobeDirsWriteAccountsDefault    = "Detected that the `%s` file with accounts was edited by the executable file `%s` from the `%s` directory (started using the `%s` arguments)"
	...
	KprobeDirsMmapAccountsDefault     = "Detected that the `%s` file with accounts was memory-mapped by the executable file `%s` from the `%s` directory (started using the `%s` arguments)"
	...
	KprobeDirsRenameAccountsDefault   = "Detected that the `%s` file with accounts was replaced with the `%s` file by the executable file `%s` from the `%s` directory (started using the `%s` arguments)"
	...
	KprobeDirsWritePamDefault    = "Detected that the `%s` file with the system authentication and authorization settings was edited by the executable file `%s` from the `%s` directory (started using the `%s` arguments)"
	...
	KprobeDirsMmapPamDefault     = "Detected that the `%s` file with the system authentication and authorization settings was memory-mapped by the executable file `%s` from the `%s` directory (started using the `%s` arguments)"
	...
	KprobeDirsRenamePamDefault   = "Detected that the `%s` file with the system authentication and authorization settings was replaced with the `%s` file by the executable file `%s` from the `%s` directory (started using the `%s` arguments)"

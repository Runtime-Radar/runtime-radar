...
func request_RuntimeStats_DetectorRating_0(ctx context.Context, marshaler runtime.Marshaler, client RuntimeStatsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq DetectorRatingReq
		metadata runtime.ServerMetadata
	)
	...
	msg, err := client.DetectorRating(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_RuntimeStats_DetectorRating_0(ctx context.Context, marshaler runtime.Marshaler, server RuntimeStatsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq DetectorRatingReq
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.DetectorRating(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterRuntimeStatsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RuntimeStatsServer) error {
	...
	mux.Handle(http.MethodPost, pattern_RuntimeStats_DetectorRating_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/runtime_stats.RuntimeStats/DetectorRating", runtime.WithHTTPPathPattern("/api/v1/stats/detector/rating"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_RuntimeStats_DetectorRating_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_RuntimeStats_DetectorRating_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterRuntimeStatsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RuntimeStatsClient) error {
	...
	mux.Handle(http.MethodPost, pattern_RuntimeStats_DetectorRating_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/runtime_stats.RuntimeStats/DetectorRating", runtime.WithHTTPPathPattern("/api/v1/stats/detector/rating"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_RuntimeStats_DetectorRating_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_RuntimeStats_DetectorRating_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"api", "v1", "stats", "detector", "rating"}, ""))
)

var (
	forward_RuntimeStats_CountEvents_0    = runtime.ForwardResponseMessage
	forward_RuntimeStats_DetectorRating_0 = runtime.ForwardResponseMessage
)

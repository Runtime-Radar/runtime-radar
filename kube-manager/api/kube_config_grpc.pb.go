...
const (
	ConfigController_Add_FullMethodName  = "/kube_config.ConfigController/Add"
	ConfigController_Read_FullMethodName = "/kube_config.ConfigController/Read"
)
...
var ConfigController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kube_config.ConfigController",

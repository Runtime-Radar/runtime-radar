...
const (
	...
	ConfigController_ResetToDefault_FullMethodName = "/runtime_config.ConfigController/ResetToDefault"
	ConfigController_Status_FullMethodName         = "/runtime_config.ConfigController/Status"
)
...
type ConfigControllerClient interface {
	...
	Status(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ConfigStatus, error)
}
...
func (c *configControllerClient) ResetToDefault(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ConfigController_ResetToDefault_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *configControllerClient) Status(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ConfigStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfigStatus)
	err := c.cc.Invoke(ctx, ConfigController_Status_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConfigControllerServer interface {
	...
	Status(context.Context, *emptypb.Empty) (*ConfigStatus, error)
...
func (UnimplementedConfigControllerServer) ResetToDefault(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResetToDefault not implemented")
}
func (UnimplementedConfigControllerServer) Status(context.Context, *emptypb.Empty) (*ConfigStatus, error) {
...
func _ConfigController_ResetToDefault_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConfigControllerServer).ResetToDefault(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConfigController_ResetToDefault_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigControllerServer).ResetToDefault(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _ConfigController_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConfigControllerServer).Status(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConfigController_Status_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigControllerServer).Status(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ConfigController_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ConfigController_ResetToDefault_Handler,
		},
		{
			MethodName: "Status",
			Handler:    _ConfigController_Status_Handler,
		},
	},
